...
const navGroups: AppShellNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "sterilization", icon: ShieldCheck },
    ],
  },
  {
...
const uiText: Record<Language, UiText> = {
  vi: {
    ...
    nav: {
      ...
      imaging: "Hình ảnh học",
      lab: "Ca labo",
      sterilization: "Vô trùng dụng cụ",
      pharmacy: "Đơn thuốc",
      forms: "Biểu mẫu",
      learning: "Đào tạo",
    ...
    titles: {
      ...
      lab: "Theo dõi ca labo",
      sterilization: "Traceability vô trùng",
  ...
  en: {
    ...
    titles: {
      ...
      lab: "Lab case tracking",
      sterilization: "Sterilization traceability",
