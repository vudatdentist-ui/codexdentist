...
const noticeText: Record<string, string> = {
  ...
  "einvoice-request-pending": "HĐĐT đang chờ xử lý. Hãy đồng bộ trạng thái thay vì gửi yêu cầu trùng.",
  "einvoice-request-state-invalid": "Trạng thái HĐĐT hiện tại không cho phép gửi yêu cầu phát hành mới.",
  "einvoice-sync-state-invalid": "Chỉ HĐĐT đang chờ hoặc lỗi mới được đồng bộ lại từ màn hình này.",
  ...
  "einvoice-manual-state-invalid": "HĐĐT đã có trạng thái cuối; dùng hủy hoặc thay thế để đối soát tiếp.",
