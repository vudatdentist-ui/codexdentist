...
- Public odontogram prototype: `https://odontogram.codexdentist.com`; it provides separate FDI charts for 32 permanent teeth and 20 primary teeth, with mirrored anatomical silhouettes and five independently selectable surfaces per tooth. Prototype state is browser-local and is not yet a patient clinical record.
