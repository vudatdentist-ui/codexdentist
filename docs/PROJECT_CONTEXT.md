...
- Public odontogram prototype: `https://odontogram.codexdentist.com`; it provides an adult FDI chart with mirrored anatomical tooth silhouettes and five independently selectable surfaces per tooth. Prototype state is browser-local and is not yet a patient clinical record.
