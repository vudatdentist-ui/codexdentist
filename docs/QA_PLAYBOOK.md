...
- `https://odontogram.codexdentist.com/` keeps the root URL, renders 32 permanent FDI teeth with upper/lower anatomical silhouettes, exposes five keyboard-accessible surfaces per tooth, persists prototype marks locally, and has no horizontal overflow at `390x844`.
